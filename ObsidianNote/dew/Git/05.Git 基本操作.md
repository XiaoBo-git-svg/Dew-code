---
title: "Git 基本操作 | 菜鸟教程"
source: "https://www.runoob.com/git/git-basic-operations.html"
author:
published:
created: 2026-06-21
description: "Git 基本操作  Git 的工作就是创建和保存你项目的快照及与之后的快照进行对比。本章将对有关创建与提交你的项目快照的命令作介绍。 Git 常用的是以下 6 个命令：git clone、git push、git add 、git commit、git checkout、git pull，后面我们会详细介绍。  说明：  workspace：工作区 staging area：暂存区/缓存区 local repository：版本库或本地.."
tags:
  - "clippings"
---
## Git 基本操作
