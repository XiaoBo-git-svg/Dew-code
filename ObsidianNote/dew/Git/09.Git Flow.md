---
title: "Git Flow | 菜鸟教程"
source: "https://www.runoob.com/git/git-flow.html"
author:
published:
created: 2026-06-21
description: "Git Flow Git Flow 是一种基于 Git 的分支模型，旨在帮助团队更好地管理和发布软件。 Git Flow 由 Vincent Driessen 在 2010 年提出，并通过一套标准的分支命名和工作流程，使开发、测试和发布过程更加有序和高效。 Git Flow 主要由以下几类分支组成："
tags:
  - "clippings"
---
