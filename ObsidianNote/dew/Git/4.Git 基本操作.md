...
tags:
  ...
  - Git基本操作
created: 2026-06-18
description: Git常用命令速查手册，包含创建、提交、分支、远程操作等
---

# Git 基本操作

> 📖 导航：[[1.Git工作流程]] | [[2.Git 工作区、暂存区和版本库]] | [[3.Git 创建仓库]]
...
- workspace：[[2.Git 工作区、暂存区和版本库#工作区|工作区]]
- staging area：[[2.Git 工作区、暂存区和版本库#暂存区|暂存区/缓存区]]
- local repository：[[2.Git 工作区、暂存区和版本库#版本库|版本库或本地仓库]]
...
- [[1.Git工作流程]] - Git 工作流程的整体概述
- [[2.Git 工作区、暂存区和版本库]] - 深入理解工作区、暂存区和版本库
